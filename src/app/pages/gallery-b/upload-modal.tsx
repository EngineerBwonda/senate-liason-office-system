...
// Client Component because it manages form state (files, links, the new
// album fields), reads the current user via the browser Supabase client,
// and talks to Supabase Storage / the `photos` and `albums` tables directly.
...
export default function UploadModal({
  ...
  // Auth check — uploads require a signed-in user, since uploaded_by
  ...
  // Returns the album id photos should be attached to, creating a new
  // album row first if the user chose "New album".
              ...
              {!creatingAlbum ? (
                ...
                <div className="mb-3">
                  <div className="d-flex gap-2 mb-2">
                    <input
                      className={styles.select}
                      placeholder="Album name, e.g. Site Inspection 2026"
                      value={newAlbumName}
